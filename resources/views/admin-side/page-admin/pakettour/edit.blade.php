...
<div id="layoutSidenav_content">
    <main>
        ...
        <h1 class="mt-4">Selamat Datang, {{Auth::user()->name}}</h1>
            ...
            <form action="{{ route('hotel.ubah', $hotel) }}" method="post"
                  ...
                  <div class="row mb-4">
                    <div class="col">
                      <div class="form-outline">
                        ...
                        <input type="text" id="form6Example1" class="form-control @error('description') is-invalid @enderror" name="description" value="{{$hotel->description}}" />                 
                        @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
