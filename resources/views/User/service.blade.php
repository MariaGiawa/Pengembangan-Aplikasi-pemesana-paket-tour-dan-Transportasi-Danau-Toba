...
<head>
   ...
   <title>Service | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/img4.jpg);">
                           ...
                           <div class="icon-box-content">
                              <h3>BEST HOTELS</h3>
                              <p>Donec temporibus consectetuer, repudiandae integer pellentesque aliquet justo at sequi,
                                 atque quasi.</p>
