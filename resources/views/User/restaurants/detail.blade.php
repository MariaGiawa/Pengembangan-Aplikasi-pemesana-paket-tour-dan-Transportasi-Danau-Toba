...
<body class="datepicker_mobile_full"> <!-- Remove this class to disable datepicker full on mobile -->
 ...
 <header>
  ...
  <div class="container">
   <div class="row">
    <div class="col-3">
     <div id="logo">
      <a href="index-2.html"><img src="img/logo.png" width="160" height="34" alt="City tours" class="logo_normal"></a>
      <a href="index-2.html"><img src="img/logo_sticky.png" width="160" height="34" alt="City tours" class="logo_sticky"></a>
     </div>
    </div>
    <nav class="col-9">
   ...
   <div class="row">
     ...
     <div id="Img_carousel" class="slider-pro">
      <div class="sp-slides">
       ...
       <div class="sp-slide">
        ...
        <img alt="Image" class="sp-image" src="{{ asset('storage/restaurant/' . $image->images) }}">
        @endforeach
       </div>
      </div>
     </div>
    ...
    <!-- <aside class="col-lg-4">
     ...
     <div class="box_style_1 expose">
      <h3 class="inner">Makanan</h3>
      <div class="row">
       <div class="col-md-12">
        <div class="form-group">
         @foreach ($images as $image)
         <img alt="Image" height="100px" width="50px" src="{{ asset('storage/restaurant/' . $image->images) }}">
         @endforeach
        </div> -->
        <!--/box_style_1 -->
  ...
  <div class="modal-dialog">
   <div class="modal-content">
    ...
    <div class="modal-body">
     ...
     <form method="post" action="http://www.ansonika.com/citytours/assets/review_hotel.php" name="review_hotel" id="review_hotel">
 ...
 <script src="{{ asset('assets/assets/js/jquery.sliderPro.min.js') }}"></script>
