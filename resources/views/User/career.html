...
<head>
   ...
   <title>Career | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         <section class="career-inner-page">
            ...
            <div class="inner-career-wrap">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-4 col-md-6">
                        <article class="career-item">
                           <figure class="career-image">
                              <img src="assets/images/img33.jpg">
                           </figure>
                           <div class="career-content">
                              <span class="job-desc">FULL TIME / PART TIME</span>
                              <h3>TRAVEL GUIDE</h3>
                              <p>
                                 Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                              </p>
                              <a href="#applyForm" class="round-btn">Apply Now</a>
                           </div>
                        </article>
                     </div>
                     <div class="col-lg-4 col-md-6">
                        <article class="career-item">
                           ...
                           <div class="career-content">
                              <span class="job-desc">RECEPTIONIST</span>
                              <h3>ALISON WHITE</h3>
                              <p>
                                 Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                              </p>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <article class="career-item">
                           <figure class="career-image">
                              <img src="assets/images/img32.jpg">
                           </figure>
                           <div class="career-content">
                              <h3>SUPERVISOR</h3>
                              <span class="job-title">FULL TIME</span>
                              <p>
                                 Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                              </p>
                              <a href="#applyForm" class="round-btn">Apply Now</a>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <article class="career-item">
                           ...
                           <div class="career-content">
                              <span class="job-desc">PART TIME</span>
                              <h3>TECH OPERATOR</h3>
                              <p>
                                 Fusce hic augue velit wisi ips quibusdam pariatur, iusto.
                              </p>
                     ...
                     <div class="col-lg-8">
                        <div id="applyForm" class="apply-form-container">
                           ...
                           <form method="get" class="apply-form">
                              <p class="width-5">
                              ...
                              <p>
                                 <input type="text" name="text" placeholder="Your Position...">
                              </p>
                              <p>
            ...
            <div class="iconbox-section bg-light-grey">
               <div class="container">
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="icon-box bg-color-box">
                           <div class="box-icon">
