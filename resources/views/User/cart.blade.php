...
<head>
   ...
   <title>Cart | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
                  ...
                  <form method="get" action="#">
                     <div class="table-responsive">
                        <table class="table">
                           ...
                           <tr>
                              ...
                              <td data-column="Product Name">SUMMER HOLIDAY TO THE OXOLOTAN RIVER</td>
                              <td data-column="Price">$ 1140.00</td>
                              ...
                              <td data-column="Sub Total">$ 1140.00</td>
                           </tr>
                           <tr>
                              <td class="">
                                 <button class="close" data-dismiss="alert" aria-label="Close"><span
                              ...
                              <td data-column="Product Name">SANTORINI ISLAND'S WEEKEND VACATION</td>
                              <td data-column="Price">$ 1300.00</td>
                              <td data-column="Quantity" class="count-input">
                                 <div>
                                    <a class="minus-btn" href="#"><i class="fa fa-minus"></i></a>
                                    <input class="quantity" type="text" value="1">
                              ...
                              <td data-column="Sub Total">$ 1300.00</td>
                           </tr>
                        </table>
                     </div>
                     <div class="updateArea">
                        <div class="input-group">
                           ...
                           <a href="#" class="outline-btn">apply coupon</a>
                        </div>
                        <a href="#" class="outline-btn update-btn">update cart</a>
                     </div>
                     <div class="totalAmountArea">
                        <ul class="list-unstyled">
                           <li><strong>Sub Total</strong> <span>$ 3600.00</span></li>
                           <li><strong>Vat</strong> <span>$ 18.00</span></li>
                           <li><strong>Grand Total</strong> <span class="grandTotal">$ 3680.00</span></li>
                        </ul>
                     </div>
                     <div class="checkBtnArea text-right">
                        <button type="submit" class="round-btn">checkout</button>
                     </div>
                  </form>
               </div>
            </div>
