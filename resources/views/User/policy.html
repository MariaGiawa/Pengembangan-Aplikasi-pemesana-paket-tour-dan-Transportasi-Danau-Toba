...
<head>
   ...
   <title>privacy policy | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         ...
         <div class="policy-section">
            <div class="container">
               <h1>Privacy Policy for company</h1>
               <p>At company name, accessible from themeforest.net, one of our main priorities is the privacy of our
                  visitors. This Privacy Policy document contains types of information that is collected and recorded by
                  company name and how we use it.</p>
               ...
               <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                  with regards to the information that they shared and/or collect in company name. This policy is not
                  applicable to any information collected offline or via channels other than this website. Our Privacy
                  Policy was created with the help of the </p>
               <h2>Consent</h2>
               ...
               <h2>Log Files</h2>
               <p>company name follows a standard procedure of using log files. These files log visitors when they visit
               ...
               <p>Like any other website, company name uses 'cookies'. These cookies are used to store information
               ...
               <p>For more general information on cookies, please read the Cookies article on Generate Privacy Policy
                  website</a>.</p>

               <h2>Advertising Partners Privacy Policies</h2>
               <P>You may consult this list to find the Privacy Policy for each of the advertising partners of company
                  name.</p>
               <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                  are used in their respective advertisements and links that appear on company name, which are sent
               ...
               <p>Note that company name has no access to or control over these cookies that are used by third-party
                  advertisers.</p>
               <h2>Third Party Privacy Policies</h2>
               <p>company name's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
               ...
               <p>The right to rectification – You have the right to request that we correct any information you believe
               ...
               <p>company name does not knowingly collect any Personal Identifiable Information from children under the
