...
<head>
   ...
   <title>Team | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
...
<body>
   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         <section class="team-inner-page">
            <!-- ***Inner Banner html start form here*** -->
            <div class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/images/img7.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="page-title">TOUR GUIDE</h1>
                     </div>
                  </div>
               </div>
            </div>
            <!-- ***Inner Banner html end here*** -->
            <!-- ***team section html start form here*** -->
            <div class="inner-team-wrap">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-4 col-md-6">
                        <article class="team-item">
                           ...
                           <div class="team-content">
                              ...
                              <h3>ALISON WHITE</h3>
                              <span class="job-title">TRAVEL AGENT</span>
                              <p>
                                 <em>“Fusce hic augue velit wisi ips quibusdam pariatur, iusto.”</em>
                              </p>
                           </div>
                        </article>
                     </div>
