...
<head>
   ...
   <title>Confirmation | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
                           ...
                           <div class="confirmation-details">
                              ...
                              <table class="table">
                                 <tbody>
                                    ...
                                    <tr>
                                       <td>Phone</td>
                                       <td>044 - 222 - 666 - 777</td>
                                    </tr>
                                    <tr>
                                       <td>Card number</td>
                                       <td>XXX-XXXX-XXX-08</td>
                                    </tr>
                                    <tr>
                                       <td>Country:</td>
                                       <td>Europe</td>
                              ...
                              <div class="details payment-details">
                                 ...
                                 <div class="details-desc">
                                    <p>Payment is successful via Visa card</p>
                                 </div>
                              </div>
                              <div class="details">
                                 <h3>VIEW BOOKING DETAILS</h3>
                                 <div class="details-desc">
                                    <p><a href="#">https://www.traveler.com/index.html</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
