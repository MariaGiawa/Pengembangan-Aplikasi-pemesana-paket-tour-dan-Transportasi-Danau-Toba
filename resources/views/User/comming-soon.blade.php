...
<head>
   ...
   <title>Comming Soon | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
...
<body>
   ...
   <div class="comming-soon-section" style="background-image: url(assets/images/banner-img1.jpg);">
      <div class="container">
         <div class="row">
            <div class="col-lg-8 offset-lg-2">
               <div class="comming-soon-wrap">
                  ...
                  <article class="comming-soon-content no-content-wrap">
                     <h3>WE ARE COMING SOON !</h3>
                     <h2>GET NOTIFIED WHEN SITE GOES LIVE.</h2>
