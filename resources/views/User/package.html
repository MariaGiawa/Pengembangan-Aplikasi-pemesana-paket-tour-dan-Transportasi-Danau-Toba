...
<head>
   ...
   <title>Packages | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
         ...
         <section class="inner-page-wrap">
            ...
            <div class="package-item-wrap">
               <div class="container">
                  ...
                  <article class="package-item">
                     <figure class="package-image" style="background-image: url(assets/images/img1.jpg);"></figure>
                     <div class="package-content">
                        <h3>
                           <a href="package-detail.html">
                              THE WONDERFUL VENICE CITY EXCITING JOURNEY
                           </a>
                        </h3>
                        <p>Laoreet, voluptatum nihil dolor esse quaerat mattis explicabo maiores, est aliquet porttitor!
                           Eaque, cras, aspernatur.</p>
