...
@section('main')
      ...
      <main id="content" class="site-main">
         ...
         <section class="home-banner d-flex flex-wrap align-items-center"
               ...
               <div class="banner-content text-center">
                  <div class="row">
                     <div class="col-lg-8 offset-lg-2">
                        ...
                        <p>Ac mi duis mollis. Sapiente? Scelerisque quae, penatibus? Suscipit class corporis nostra rem
                           quos voluptatibus habitant? Fames, vivamus minim nemo enim, gravida lobortis quasi, eum.</p>
