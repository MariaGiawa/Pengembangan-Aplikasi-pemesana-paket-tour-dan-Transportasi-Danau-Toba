...
<head>
   ...
   <title>Search | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
                        ...
                        <div class="search-content-wrap">
                           <article class="post">
                              <div class="entry-content">
                                 <h3>
                                    <a href="#">SANTORINI ISLAND'S WEEKEND VACATION</a>
                                 </h3>
                                 <p>Praesent, risus adipisicing donec! Cras. Lobortis id aliquip taciti repudiandae
                                    porro dolore facere officia! Natoque mollitia ultrices convallis nisl suscipit</p>
                           ...
                           <article class="post">
                              <div class="entry-content">
                                 ...
                                 <div class="entry-text">
                                    <p>Interdum veritatis quas minus eligendi urna eius, ea platea. Neque aut, eiusmod,
                                    </p>
                                 </div>
                                 <div class="button-container">
                                    <a href="#" class="button-text">Read More</a>
                     ...
                     <div class="col-lg-4 grid-item">
                        <div class="search-content-wrap">
                           <article class="post">
                              <div class="entry-content">
                                 <h3>
                                    <a href="#">WEEKEND TO PARIS</a>
                                 </h3>
                                 <p>Augue senectus quisque, repellat deserunt fugiat! Quasi nostra montes tellus montes?
                                    Cumque vivamus laborum, expedita quis exercitationem eiusmod. Illo orci ullamcorper!
                                    Augue senectus quisque, repellat deserunt fugiat! Quasi nostra montes tellus montes?
                                    Cumque vivamus laborum, expedita quis exercitationem eiusmod. Illo orci ullamcorper!
                                 </p>
                                 <div class="button-container">
                                    <a href="#" class="button-text">Read More</a>
                        ...
                        <div class="search-content-wrap">
                           <div class="search-content-wrap">
                              <article class="post">
                                 <div class="entry-content">
                                    <h3>
                                       <a href="#">TOUR TO SATORINI</a>
                                    </h3>
                                    <p>Augue senectus quisque, repellat deserunt fugiat! Quasi nostra montes tellus
                                       montes? Cumque vivamus laborum, expedita quis exercitationem eiusmod. Illo orci
                                       ullamcorper! Augue senectus quisque, repellat deserunt fugiat! Quasi nostra
                                       montes tellus montes? Cumque vivamus laborum, expedita quis exercitationem
                                       eiusmod. Illo orci ullamcorper!</p>
                                    <div class="button-container">
                                       <a href="#" class="button-text">Read More</a>
                                    </div>
                                 </div>
                           ...
                           <article class="post">
                              <div class="entry-content">
                                 ...
                                 <p>Amet orci, nibh blanditiis tempor soluta bibendum, omnis dictumst eiusmod felis
                                    mollis porta molestiae, laborum fugiat, phasellus minim labore habitasse</p>
                                 <div class="button-container">
                                    <a href="#" class="button-text">Read More</a>
                                 </div>
                              </div>
