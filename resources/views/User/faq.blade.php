...
<head>
   ...
   <title>FAQ | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div id="accordion-tab-one" class="accordion-content" role="tablist">
                              <div id="accordion-A" class="card tab-pane fade show active" role="tabpanel"
                                 ...
                                 <div id="collapse-one" class="collapse show" data-bs-parent="#accordion-tab-one"
                                    role="tabpanel" aria-labelledby="qus-A">
                                    <div class="card-body">
                                       Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis voluptas,
                                       harum officia ante aliquet blanditiis scelerisque donec illo aperiam commodi
                                       hymenaeos.
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div id="accordion-C" class="card tab-pane" role="tabpanel" aria-labelledby="accordion-C">
                                 ...
                                 <div id="collapse-three" class="collapse" data-bs-parent="#accordion-tab-one"
                        ...
                        <div class="col-lg-6">
                           <div class="faq-testimonial">
                              ...
                              <div class="testimonial-content">
                                 ...
                                 <p>Tempora sem nostrum porta libero ad parturient vestibulum laboriosam luctus dis,
                                    reprehenderit modi, felis esse laudan tium.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-lg-8 offset-lg-2 text-sm-center">
                           <div class="section-heading">
                              ...
                              <p>Fusce hic augue velit wisi quibusdam pariatur, iusto primis, nec nemo, rutrum.
                                 Vestibulum cumque laudantium. Sit ornare mollitia tenetur, aptent.</p>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                           ...
                           <div class="faq-content-wrap">
                              <div id="accordion-tab-two" class="accordion-content" role="tablist">
                                 <div id="accordion-E" class="card tab-pane fade show active" role="tabpanel"
                                    ...
                                    <div id="collapse-five" class="collapse show" data-bs-parent="#accordion-tab-two"
                                       role="tabpanel" aria-labelledby="qus-E">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
                                       </div>
                                    </div>
                                 </div>
                                 <div id="accordion-F" class="card tab-pane" role="tabpanel"
                                    ...
                                    <div class="card-header" role="tab" id="qus-F">
                                       <h5 class="mb-0">
                                          <a class="collapsed" data-bs-toggle="collapse" href="#collapse-six"
                                             aria-expanded="false" aria-controls="collapse-six">
                                             DO I HAVE TO MAKE RESERVATION?
                                          </a>
                                       </h5>
                                    </div>
                                    <div id="collapse-six" class="collapse" data-bs-parent="#accordion-tab-two"
                                       role="tabpanel" aria-labelledby="qus-F">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
                                 ...
                                 <div id="accordion-G" class="card tab-pane" role="tabpanel"
                                    ...
                                    <div class="card-header" role="tab" id="qus-G">
                                       <h5 class="mb-0">
                                          <a class="collapsed" data-bs-toggle="collapse" href="#collapse-seven"
                                             aria-expanded="true" aria-controls="collapse-seven">
                                             WHAT BENEFITS YOU GET FRIM BOOKING?
                                          </a>
                                       </h5>
                                    </div>
                                    <div id="collapse-seven" class="collapse" data-bs-parent="#accordion-tab-two"
                                       role="tabpanel" aria-labelledby="qus-G">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
                        ...
                        <div class="col-lg-6">
                           <div class="faq-content-wrap">
                              <div id="accordion-tab-three" class="accordion-content" role="tablist">
                                 <div id="accordion-I" class="card tab-pane fade show active" role="tabpanel"
                                    aria-labelledby="accordion-I">
                                    <div class="card-header" role="tab" id="qus-I">
                                       <h5 class="mb-0">
                                          <a data-bs-toggle="collapse" href="#collapse-nine" aria-expanded="true"
                                             aria-controls="collapse-nine">
                                             How do we manage to fund charity ?
                                          </a>
                                       </h5>
                                    </div>
                                    <div id="collapse-nine" class="collapse show" data-bs-parent="#accordion-tab-three"
                                       role="tabpanel" aria-labelledby="qus-I">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
                                 ...
                                 <div id="accordion-J" class="card tab-pane" role="tabpanel"
                                    ...
                                    <div class="card-header" role="tab" id="qus-J">
                                       <h5 class="mb-0">
                                          <a class="collapsed" data-bs-toggle="collapse" href="#collapse-ten"
                                             aria-expanded="false" aria-controls="collapse-ten">
                                             How did we manage your fund raised ?
                                          </a>
                                       </h5>
                                    </div>
                                    <div id="collapse-ten" class="collapse" data-bs-parent="#accordion-tab-three"
                                       role="tabpanel" aria-labelledby="qus-J">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
                                 ...
                                 <div id="accordion-K" class="card tab-pane" role="tabpanel"
                                    aria-labelledby="accordion-K">
                                    <div class="card-header" role="tab" id="qus-K">
                                       <h5 class="mb-0">
                                          <a class="collapsed" data-bs-toggle="collapse" href="#collapse-eleven"
                                             aria-expanded="true" aria-controls="collapse-eleven">
                                             How to donate your money for charity ?
                                          </a>
                                       </h5>
                                    </div>
                                    <div id="collapse-eleven" class="collapse" data-bs-parent="#accordion-tab-three"
                                       role="tabpanel" aria-labelledby="qus-K">
                                       <div class="card-body">
                                          Natoque consequat sodales autem nihil nec. Fusce molestias? Reiciendis
                                          voluptas, harum officia ante aliquet blanditiis scelerisque donec illo aperiam
                                          commodi hymenaeos.
