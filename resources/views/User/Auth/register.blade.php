...
<body>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-8">
                        <div id="login">
                            <div class="text-center"><img src="assets/img/logo.jpeg" alt="Image" width="160" height="34"></div>
                            <hr>
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="form-group">
                                    <label>Username</label>
                                    <input id="name" type="text" name="name" value="{{ old('name') }}" class=" form-control" placeholder="Username" required autofocus>
                                </div>
    ...
    <script src="{{ asset('assets/assets/js/pw_strenght.js') }}"></script>
