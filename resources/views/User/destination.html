...
<head>
   ...
   <title>Destination | Traveler – Travel & Trip Business HTML5 Template</title>
</head>
            ...
            <div class="destination-item-wrap">
               <div class="container">
                  <div class="row gx-5">
                     ...
                     <div class="col-lg-4 col-md-6">
                        <article class="destination-item" style="background-image: url(assets/images/img16.jpg);">
                           <div class="destination-content">
                              <div class="rating-start-wrap">
                                 <div class="rating-start">
                                    <span style="width: 100%"></span>
                              ...
                              <span class="cat-link">
                                 <a href="destination.html">CROATIA</a>
                              </span>
                              <h3>
                                 <a href="package-detail.html">ALPS VALLEY</a>
                              </h3>
                              <p>Fusce hic augue velit wisi ips quibusdam pariatur, iusto.</p>
                           </div>
                        </article>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <article class="destination-item" style="background-image: url(assets/images/img10.jpg);">
                           <div class="destination-content">
                              <div class="rating-start-wrap">
                                 <div class="rating-start">
                                    <span style="width: 100%"></span>
                              ...
                              <h3>
                                 <a href="package-detail.html">MOUNT TENZEN</a>
                              </h3>
                              <p>Fusce hic augue velit wisi ips quibusdam pariatur, iusto.</p>
                           </div>
                        </article>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <article class="destination-item" style="background-image: url(assets/images/img9.jpg);">
                           <div class="destination-content">
                              <div class="rating-start-wrap">
                                 <div class="rating-start">
                                    <span style="width: 100%"></span>
                              ...
                              <h3>
                                 <a href="package-detail.html">EIFFEL TOWER</a>
                              </h3>
                              <p>Fusce hic augue velit wisi ips quibusdam pariatur, iusto.</p>
                           </div>
                        </article>
