...
<body>
   ...
   <header>
      ...
      <div class="container" style="text-align: center;">
         <div class="row">
            ...
            <!-- <div class="col-3">
               <div id="logo">
                  <a href="index-2.html"><img src="{{ asset('assets/assets/img/logo_sticky.png') }}" width="160" height="34" alt="City tours" class="logo_normal"></a>
                  <a href="index-2.html"><img src="{{ asset('assets/assets/img/logo.png') }}" width="160" height="34" alt="City tours" class="logo_sticky"></a>
               </div> -->
            </div>
            <nav class="col-9">
               <a class="cmn-toggle-switch cmn-toggle-switch__htx open_close" href="javascript:void(1);"><span>Menu mobile</span></a>
               <div class="main-menu">
                  <div id="header_menu">
   ...
   <section class="parallax" data-parallax="scroll" data-image-src="{{ asset('assets/assets/img/restauran.jpg') }}" data-natural-width="1400" data-natural-height="470">
      <div class="parallax">
         <div class="parallax__layer parallax__layer--back">
            <img src="{{ asset('assets/img/restauran1.jpg') }}" alt="Background image" width="1400px" height="450px">
         </div>
         <div class="parallax__layer parallax__layer--front">
            <div class="parallax__content">
               <img src="{{ asset('assets/img/restauran1.jpg') }}" alt="Background image" width="1400px" height="80px">
  ...
  <script src="{{ asset('assets/assets/js/common_scripts_min.js') }}"></script>
   ...
   <!-- / <script src="assets/assets/js/functions.js"></script> -->
    ...
    <!-- Specific scripts -->
    <!-- Cat nav mobile -->
    <!-- <script src="assets/assets/js/cat_nav_mobile.js"></script> -->
   <!-- <link href="{{ asset('assets/assets/css/bootstrap.min.css') }}" rel="stylesheet"> -->
   <script src="{{ asset('assets/assets/css/bootstrap.min.css') }}"></script>
    ...
    <!-- <script src="assets/assets/js/map_restaurants.js"></script> -->
   <!-- <link href="{{ asset('assets/assets/js/map_restaurants.js') }}" rel="stylesheet"> -->
   <script src="{{ asset('assets/assets/js/map_restaurants.js') }}"></script>

   <!-- <link href="{{ asset('assets/assets/js/infobox.js') }}" rel="stylesheet"> -->
   ...
   <!-- <link href="{{ asset('assets/assets/js/switcher.js') }}" rel="stylesheet"> -->
